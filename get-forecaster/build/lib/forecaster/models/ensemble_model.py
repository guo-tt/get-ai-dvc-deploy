...
class EnsembleModel(BaseEstimator, RegressorMixin):
    ...
    """
    def __init__(self, freq='30min', horizon='1d', models=['Linear', 'LGB', 'XGB', 'Sarimax', 'LSTM'], lgb_params=None, xgb_params=None, linear_params={}, sarimax_params={}, lstm_params={}, ensemble_method='median', weights=None, cyclic_feature_encoding='sincos'):
