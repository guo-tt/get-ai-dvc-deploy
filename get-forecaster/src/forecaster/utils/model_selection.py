...
from forecaster.models.baseline_model import BaselineModel
...
def randomized_search(model, X, parameters=None, hybrid_model1=['LinearTrend'], hybrid_model2=['Linear', 'LGB', 'XGB', 'LSTM', 'Sarimax'], model1_parameters=None, model2_parameters=None, n_iter=50, test_size=0.2, stride='1d', retrain_stride=False, random_state=None):
